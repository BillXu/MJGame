...
protected:
	...
	bool checkHaveJiangJustQueShun( std::vector<uint8_t>& vec, std::vector<uint8_t>& vecOutQue );
	bool checkJustQueJiang( std::vector<uint8_t>& vec, std::vector<uint8_t>& vecOutQue );
